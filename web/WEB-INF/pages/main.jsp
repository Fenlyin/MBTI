...
<header class="Hui-header cl">
	<a class="Hui-logo l" href="${pageContext.request.contextPath }"><img
	...
	<span class="Hui-userbox">
		...
		<c:if test="${not empty current_user }">您好,${current_user.name }</c:if>
				...
				<a class="btn btn-out radius ml-10" href="${pageContext.request.contextPath }/users?opr=logout"
					 title="退出">
				<i class="icon-off"></i>
					退出
				</a>
	...
	<aside class="Hui-aside" style="">
		<div class="menu_dropdown bk_2">
			<c:if test="${current_user.type!=4 }">
				...
				<dl id="menu-article">
					<dt>
						<a _href="${pageContext.request.contextPath }/dimension/list.action" href="javascript:void(0)"> <i
								class="icon-edit"></i> 性格维度管理<b></b>
						</a>
					</dt>
				</dl>
				<dl id="menu-picture">
					<dt>
						<a _href="${pageContext.request.contextPath }/question/list.action" href="javascript:void(0)"> <i
				...
				<dl id="menu-product">
					<dt>
						<a _href="${pageContext.request.contextPath }/testPersonnel/list.action" href="javascript:void(0)"> <i
								class="icon-beaker"></i> 参测人员管理<b></b>
						</a>
					</dt>
				</dl>
				<dl id="menu-product">
					<dt>
						<a _href="${pageContext.request.contextPath }/schedule/list.action" href="javascript:void(0)"> <i
								class="icon-beaker"></i>
							测试安排<b></b>
						</a>
					</dt>
