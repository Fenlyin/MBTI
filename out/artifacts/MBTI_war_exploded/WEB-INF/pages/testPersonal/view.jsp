...
<body>
  <div style="padding: 10px;">
    <a href="${pageContext.request.contextPath }/testPersonnel/list.action?tid=${testPersonnel.teamId }" class="button"><button class="btn btn-primary" style="margin-bottom: 10px">返回列表</button></a>
